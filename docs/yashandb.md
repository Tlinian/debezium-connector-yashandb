...
10. 配置debezium YashanDB connector, 如下：
   ...
   
   {
       ...
       "config": {
           ...
           "lob.enabled" : "true",
           "schema.history.internal.kafka.bootstrap.servers" : "<KAFKA_ID_ADDRESS>:9092",
...
| connector.class                 | No default                                     | 连接器的Java类的名称。在YashanDB连接器中始终使用值“io.debezium.connector.yashandb.YashanDBConnector”。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| database.ystream.server.name    | No default                                     | YashanDB数据库的YStream服务名称，请指定步骤《3.2.3 配置YStream服务》中创建的YStream服务名称。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| topic.prefix                    | No default                                     | 主题前缀，为连接器从中捕获更改的YashanDB数据库服务器提供命名空间。您设置的值将用作连接器发出的所有Kafka主题名称的前缀。指定一个在Debezium环境中的所有连接器中唯一的主题前缀。以下字符有效：字母数字字符、连字符、点和下划线。注意：不要更改此属性的值。如果更改名称值，重新启动后，连接器将向名称基于新值的主题发出后续事件，而不是继续向原始主题发出事件。连接器也无法恢复其数据库架构历史主题。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| snapshot.locking.mode  | No default                                          | 快照数据同步前获取表结构加锁防止DDL变更。none: 不加任意锁；shared: 加共享锁; 不配置不加锁。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
当 Debezium YashanDB 连接器检测到表行的值发生更改时，它会发出表示该更改的更改事件。 每个更改事件记录的结构与原始表的结构相同，事件记录包含每个列值的字段。 表列的数据类型决定了连接器如何在更改事件字段中表示列的值，如以下各节中的表所示。
