...
public class YashanDBValueConverters extends JdbcValueConverters {
    ...
    protected BigDecimal withScaleAdjustedIfNeeded(Column column, BigDecimal data) {
        // deal with YashanDB negative scales
    ...
    private void convertYashanDBIntervalYearMonth(String data, ResultReceiver r) {
        final String interval = data;
        int sign = 1;
        int start = 0;
    ...
    private void convertYashanDBIntervalDaySecond(String data, ResultReceiver r) {
        final String interval = data;
